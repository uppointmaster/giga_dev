...
class CustomerCartEditController extends AbstractController
{
    /**
     ...
     * お届け先編集画面.
     *
     * @Route("/%eccube_admin_route%/customer/{id}/cart/new", name="admin_customer_cart_new", requirements={"id" = "\d+"}, methods={"GET", "POST"})
     * @Route("/%eccube_admin_route%/customer/{id}/cart/{did}/edit", name="admin_customer_cart_edit", requirements={"id" = "\d+", "did" = "\d+"}, methods={"GET", "POST"})
     * @Template("@admin/Customer/cart_edit.twig")
     */
    public function edit(Request $request, Customer $Customer, $did = null)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_customer_cart_edit', [
                'id' => $Customer->getId(),
    ...
    /**
     * @Route("/%eccube_admin_route%/customer/{id}/cart/{did}/delete", requirements={"id" = "\d+", "did" = "\d+"}, name="admin_customer_cart_delete", methods={"DELETE"})
     */
