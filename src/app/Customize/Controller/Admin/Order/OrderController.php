...
use Customize\Form\Type\Admin\OrderInvoiceType;
...
use Customize\Service\OrderInvoiceService;
use Customize\Service\OrderReceiptService;
...
class OrderController extends AbstractController
{
    ...
    /**
     * @Route("/%eccube_admin_route%/order/export/invoice", name="admin_order_export_invoice", methods={"GET", "POST"})
     * @Template("@admin/Order/order_invoice.twig")
     *
     * @param Request $request
     *
     * @return array|RedirectResponse
    ...
    public function exportInvoice(Request $request)
    {
        ...
        if (!$OrderPdf) {
            $OrderPdf = new OrderPdf();
            $OrderPdf
                ->setTitle(trans('admin.order.invoice_note_title__default'))
                ->setMessage1(trans('admin.order.invoice_note_message__default1'));
        }

        /**
         * @var FormBuilder
         */
        $builder = $this->formFactory->createBuilder(OrderInvoiceType::class, $OrderPdf);
    ...
    /**
     * @Route("/%eccube_admin_route%/order/export/invoice/download", name="admin_order_invoice_download", methods={"POST"})
     * @Template("@admin/Order/order_invoice.twig")
     *
     * @param Request $request
     *
     * @return Response
     */
    public function exportInvoiceDownload(Request $request, OrderInvoiceService $orderPdfService)
    {
        /**
         * @var FormBuilder
         */
        $builder = $this->formFactory->createBuilder(OrderInvoiceType::class);
        ...
        if (!$form->isValid()) {
            ...
            return $this->render('@admin/Order/order_invoice.twig', [
                'form' => $form->createView(),
            ]);
        }
        ...
        // 宛名を配列にセット
        $addressKind = $form->get('address_kind')->getData();
        $arrData['address_kind'] = $addressKind;
    ...
    /**
     * @Route("/%eccube_admin_route%/order/export/receipt", name="admin_order_export_receipt", methods={"GET", "POST"})
     * @Template("@admin/Order/order_receipt.twig")
     *
     * @param Request $request
     *
     * @return array|RedirectResponse
    ...
    /**
     * @Route("/%eccube_admin_route%/order/export/receipt/download", name="admin_order_receipt_download", methods={"POST"})
     * @Template("@admin/Order/order_receipt.twig")
     *
     * @param Request $request
     *
     * @return Response
     */
    public function exportReceiptDownload(Request $request, OrderReceiptService $orderPdfService)
    {
        /**
         * @var FormBuilder
         */
