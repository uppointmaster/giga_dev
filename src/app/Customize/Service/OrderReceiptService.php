 ...
 */
class OrderReceiptService extends Fpdi
{
    /** @var OrderRepository */
    ...
    public function makePdf(array $formData)
    {
        ...
        foreach ($ids as $id) {
            ...
            // タイトルを描画する
            $this->renderTitle(trans('admin.order.output_receipt_title')); //$formData['title']);
    ...
    public function getPdfFileName()
    {
        ...
        if ($this->PageNo() == 1) {
            $this->downloadFileName = 'ryoushusyo-No'.$this->lastOrderId.'.pdf';
        }
    ...
    {
        $this->lfText(20, 70, trans('admin.order.output_receipt_message'), 9); // メッセージ1 $formData['message1']
        //$this->lfText(20, 74, $formData['message2'], 8); // メッセージ2
        //$this->lfText(20, 78, $formData['message3'], 8); // ッセージ3
    }
